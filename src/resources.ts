...
export function registerResources(server: McpServer): void {
  server.registerResource(
    ...
    "agent-ready://methodology",
    {
      ...
      description:
        "How Agent Ready computes the 0–100 readability score and the llms.txt sub-score. Covers the 70 checks across four categories, rating bands, weighting, and JS-rendering handling.",
